...
\begin{enumerate}
  ...
  という近似が成り立つ。
%   という近似が成り立つから、
%   $-\left(\sin\Theta_{S\rightarrow BL} \sin\theta_{S\rightarrow BL} + \frac{I_{BL}}{I_{S\rightarrow BL}}\cos\Theta_{S\rightarrow BL} \cos\theta_{S\rightarrow BL}\right)$
%   によって正負が決定する。
%   例えば$\Theta_{S\rightarrow BL} = \pi$である状況では
%   \begin{align*}
%     -\left(\sin\Theta_{S\rightarrow BL} \sin\theta_{S\rightarrow BL} + \frac{I_{BL}}{I_{S\rightarrow BL}}\cos\Theta_{S\rightarrow BL} \cos\theta_{S\rightarrow BL}\right)
%     = -\left(-\frac{I_{BL}}{I_{S\rightarrow BL}}\cos\theta_{S\rightarrow BL}\right) = \frac{I_{BL}}{I_{S\rightarrow BL}}\cos\theta_{S\rightarrow BL}
%   \end{align*}
%   であるから、
%   $\cos\theta_{S\rightarrow BL}$によって正負が決定される。
%   図\ref{PN_horizontal_positive.png}の状況では
%   $\cos\theta_{S\rightarrow BL}>0$であるから、
%   上肢は正の方向に加速する。
...
\begin{align*}
  ...
  % = Mg\sin\Theta_{S\rightarrow BL}\cos\theta_{S\rightarrow BL} &+& Ma\sin\theta_{S\rightarrow BL}\cos\theta_{S\rightarrow BL} &- &F_S\cos^2\theta_{S\rightarrow BL}
...
正であることを保証しない。
大体正であるためには、
$-ML_{S\rightarrow BL}\Omega_{S\rightarrow BL}{}^2\cos\theta_{S\rightarrow BL} < 0$であるうちは
